...
public class Wow_PlayerInfo {
    ...
    public float m_angleCounterClockWise360 = 0f;
...
public class Wow_PlayerInfoEvent
{
    ...
    public UnityEvent<Vector2> m_onMapPositionLRTD;
    public UnityEvent<Vector3> m_onWorldPositionRLDT;
    public UnityEvent<float> m_onPlayerAngle360;
    public UnityEvent<WowPlayerPosition360> m_onPlayerPositionUpdated;
